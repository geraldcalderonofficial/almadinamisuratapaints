...
$_['entry_code']           = 'الرمز العالمي للعملة:<br /><span class="help">لا تقم بتغييرها اذا كانت هذه هي العملة الافتراضية وتغييرها سوف يسبب مشاكل في المتجر - فقط يمكنك التغيير اذا كانت هذه العملة ليست هي العملة الافتراضية. ويجب إدخال <a href="http://www.xe.com/iso4217.php" target="_blank">الرمز العالمي للعملة</a> بشكل صحيح</span>';
$_['entry_value']          = 'القيمة:<br /><span class="help">ضع القيمة 1.00000 اذا كانت هذه هي العملة الافتراضية.</span>';
