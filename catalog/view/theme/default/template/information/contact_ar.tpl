        ...
        <div class="contact-info">
          <div class="content">
            <div class="left">
                ...
                <span style="padding-left: 10px; text-align: left!important;"><?php echo $store; ?></span> <br />
                <span style="padding-left: 10px; text-align: left!important;"><?php echo $address; ?></span><br /><br /> 
          ...
          <div class="right">
            ...
            <span style="padding-left: 10px;"><?php echo $telephone; ?> - Commercial Management</span><br />
            <span style="padding-left: 10px;">218512722008+ / 218512722009+ - Company's Management</span> <br /><br />
            <?php } ?>
            <?php if ($fax) { ?>
            <span class="icon icon i-mobile no-bg-color"></span><b><?php echo $text_fax; ?></b><br />
            <span style="padding-left: 10px;"><?php echo $fax; ?></span>
            <?php } ?>
          </div>
        </div>
        </div>
