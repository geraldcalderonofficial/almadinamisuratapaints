...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="sitemap-info">
	...
	<div>
                <div class="app-video">
		<a href="index.php?route=information/news#close" title="Close" class="close">X</a>
...
<ul class="app-tn">
	...
	<h4 class="news-content-title"><a href="index.php?route=information/news#openModal1"><?php echo $text_ntitle1; ?></a></h4>
	...
	<div class="news-btn"><a href="index.php?route=information/news#openModal1"><?php echo $text_nbutton; ?></a></div>
	</div>
	</div>
	</li>
	<li>
	...
	<div class="news-content-right">
	<h4 class="news-content-title"><a href="index.php?route=information/news#openModal2"><?php echo $text_ntitle2; ?></a></h4>

	<p><?php echo $text_ntitle2p1; ?></p>

	<p style="margin-bottom: 0!important;"><?php echo $text_ntitle2p2; ?></p>

	<div class="news-btn right"><a href="index.php?route=information/news#openModal2"><?php echo $text_nbutton; ?></a></div>
	</div>
	</div>
	</li>
	<li>
	...
	<div class="news-content-right">
	<h4 class="news-content-title"><a href="index.php?route=information/news#openModal3"><?php echo $text_ntitle3; ?></a></h4>
	...
	<div class="news-btn right"><a href="index.php?route=information/news#openModal3"><?php echo $text_nbutton; ?></a></div>
	</div>
	</div>
	</li>
	<li>
	...
	<div class="news-content-right">
	<h4 class="news-content-title"><a href="index.php?route=information/news#openModal4"><?php echo $text_ntitle4; ?></a></h4>
	...
	<div class="news-btn right"><a href="index.php?route=information/news#openModal4"><?php echo $text_nbutton; ?></a></div>
	</div>
	</div>
	</li>
	<li>
	...
	<div class="news-content-right">
            <h4 class="news-content-title"><a href="index.php?route=information/news#openModal5"><?php echo $text_ntitle5; ?></a></h4>

            <p><?php echo $text_ntitle5p1; ?><span style="color:#ffffff;">an oily completely safe paint to health and environment which is diluted by water. It is vulnerable to yellowness and it has all the characteristics and power of the oily paint.</span></p>

            <p style="margin-bottom: 0!important;">&nbsp;</p>

            <div class="news-btn " ><a href="index.php?route=information/news#openModal5"><?php echo $text_nbutton; ?></a></div>
	</div>
	</div>
	</li>
