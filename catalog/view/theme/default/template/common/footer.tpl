                                    ...
                                    <div class="block-content" style="display: none;">
                                     <ul class="bullet footer-bullet">
                                         <li><a href="index.php?route=common/home"><?php echo $text_home; ?></a></li>
                                            <li><a href="index.php?route=information/about"><?php echo $text_about; ?></a></li>
                                           <li><a href="index.php?route=product/category&path=94_106">Products</a></li>
                                            <li><a href="index.php?route=information/stores"><?php echo $text_stores; ?></a></li>
                                ...
                                <div class="block-content" style="display: none;">
                                     <ul class="bullet footer-bullet">
                                         ...
                                         <li><a href="index.php?route=information/contact"><?php echo $text_contact; ?></a></li>
                                            ...
                                            <li><a href="index.php?route=product/search&search"><?php echo $text_search; ?></a></li>
                                            ...
                                            <li><a href="index.php?route=information/sitemap"><?php echo $text_sitemap; ?></a></li>
                                    </ul>
                                </div>  
                            </div>
                        </div>
    ...
    <div class="footer-bottom-container section-container">
        <div class="footer-bottom footer container show-bg show-bg">
            <div class="grid-full">
                ...
                <div class="clearer">
                	<div class="item item-left" style="height: 0;">
                            <p class="footer-copyright" style="padding-top: 5px;">Copyright © 2014 <a href="index.php?route=common/home"> Almadina Misurata Paints.</a> All Rights Reserved.
                        </div>
