                                ...
                                <div class="header-main v-grid-container hcontainer-header">
                                    ...
                                    <div class="left" style="width: 60%;">
                                            ...
                                            <div style="vertical-align: top; float: left;">
                                                ...
                                                <div class="search-wrapper-p0  search-wrapper search-wrapper-mobile" style="margin-top: 1.3em; ">
                        ...
                        <div class="nav-container grid-full-wide">
                                       ...
                                       <ul class="accordion vertnav vertnav-top grid-full">
                                        ...
                                        <ul id="nav" class="grid-full">
                                                ...
                                                <li class="level0 nav-6 level-top parent">
                                                    <?php if ($categories) { ?>
                                                    <a href="index.php?route=product/category_ar&path=94" class="level-top"><span><?php echo $text_products; ?> <span class="cat-label cat-label-label1 pin-bottom">New</span></span><div class="caret">&nbsp;</div></a>
