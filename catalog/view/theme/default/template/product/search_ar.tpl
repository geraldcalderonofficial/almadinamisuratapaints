  ...
  --><div class="product-list2">
    ...
    <div>
        ...
        <div>
               ...
               <!-- <div class="price"  style="border: 1px dashed red;">
...
function display(view) {
	if (view == 'list') {
		$('.product-grid').attr('class', 'product-list2');
		
		$('.product-list2 > div').each(function(index, element) {
		...
		$('.product-list2').attr('class', 'product-grid');
