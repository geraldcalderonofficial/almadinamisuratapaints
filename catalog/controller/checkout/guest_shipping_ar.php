<?php 
class ControllerCheckoutGuestShippingAr extends Controller {
  	public function index() {	
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkout/guest_shipping_ar.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/checkout/guest_shipping_ar.tpl';
		} else {
			$this->template = 'default/template/checkout/guest_shipping_ar.tpl';
		}		
