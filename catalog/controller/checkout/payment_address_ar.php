<?php 
class ControllerCheckoutPaymentAddressAr extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkout/payment_address_ar.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/checkout/payment_address_ar.tpl';
		} else {
			$this->template = 'default/template/checkout/payment_address_ar.tpl';
		}
