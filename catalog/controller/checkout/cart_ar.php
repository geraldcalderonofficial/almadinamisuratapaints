<?php 
class ControllerCheckoutCartAr extends Controller {
	private $error = array();
	...
	public function index() {
    	...
    	if ($this->cart->hasProducts() || !empty($this->session->data['vouchers'])) {
			...
			if ($this->config->get('config_customer_price') && !$this->customer->isLogged()) {
				$this->data['attention'] = sprintf($this->language->get('text_login'), $this->url->link('account/login_ar'), $this->url->link('account/register_ar'));
			} else {
				$this->data['attention'] = '';
			}
			...
			$this->data['action'] = $this->url->link('checkout/cart_ar');   
            ...
            foreach ($products as $product) {
                ...
                $this->data['products'][] = array(
                    ...
                    'price'               => $price,
                    'total'               => $total,
                    'href'                => $this->url->link('product/product_ar', 'product_id=' . $product['product_id']),
                    'remove'              => $this->url->link('checkout/cart_ar', 'remove=' . $product['key']),
			...
			if (!empty($this->session->data['vouchers'])) {
				foreach ($this->session->data['vouchers'] as $key => $voucher) {
					$this->data['vouchers'][] = array(
						...
						'remove'      => $this->url->link('checkout/cart_ar', 'remove=' . $key)   
					);
				}
			}
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkout/cart_ar.tpl')) {
				$this->template = $this->config->get('config_template') . '/template/checkout/cart_ar.tpl';
			} else {
				$this->template = 'default/template/checkout/cart_ar.tpl';
			}
	...
	public function add() {
		...
		if ($product_info) {			
			...
			if (!$json) {
				...
				$json['success'] = sprintf($this->language->get('text_success'), $this->url->link('product/product_ar', 'product_id=' . $this->request->post['product_id']), $product_info['name'], $this->url->link('checkout/cart_ar'));
				...
				$json['redirect'] = str_replace('&amp;', '&', $this->url->link('product/product_ar', 'product_id=' . $this->request->post['product_id']));
			}
		}
	...
	public function quote() {
		...
		if (!$this->cart->hasShipping()) {
			$json['error']['warning'] = sprintf($this->language->get('error_no_shipping'), $this->url->link('information/contact_ar'));				
		}				
