<?php  
class ControllerCommonColumnRightAcc extends Controller {
	protected function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/column_right_acc.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/common/column_right_acc.tpl';
		} else {
			$this->template = 'default/template/common/column_right_acc.tpl';
		}
