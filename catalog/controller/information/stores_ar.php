<?php  
class ControllerInformationStoresAr extends Controller {
	public function index() {
		...
		$this->document->setTitle($this->language->get('heading_title')); 
      	...
      	$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('information/stores_ar'),      	
	...
	$this->data['news'] = $this->url->link('information/news_ar');
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/information/stores_ar.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/information/stores_ar.tpl';
		} else {
			$this->template = 'default/template/information/stores_ar.tpl';
		}
