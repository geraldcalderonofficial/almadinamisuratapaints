<?php  
class ControllerInformationApplication extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/information/application.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/information/application.tpl';
		} else {
			$this->template = 'default/template/information/application.tpl';
		}
