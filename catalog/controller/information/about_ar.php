<?php  
class ControllerInformationAboutAr extends Controller {
	public function index() {
		...
		$this->document->setTitle($this->language->get('heading_title')); 
      	...
      	$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('information/about_ar'),      	
        ...
        $this->data['text_msgp1'] = $this->language->get('text_msgp1');
        $this->data['text_msgp2'] = $this->language->get('text_msgp2');
        $this->data['text_ctitle'] = $this->language->get('text_ctitle');
        $this->data['text_cname'] = $this->language->get('text_cname');
        
        $this->data['text_cinfo'] = $this->language->get('text_cinfo');
        $this->data['text_cinfop1'] = $this->language->get('text_cinfop1');
        $this->data['text_cinfop2'] = $this->language->get('text_cinfop2');
        $this->data['text_cinfop3'] = $this->language->get('text_cinfop3');
        $this->data['text_cinfop4'] = $this->language->get('text_cinfop4');
        $this->data['text_cinfop5'] = $this->language->get('text_cinfop5');
	...
	$this->data['news'] = $this->url->link('information/news_ar');
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/information/about_ar.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/information/about_ar.tpl';
		} else {
			$this->template = 'default/template/information/about_ar.tpl';
		}
