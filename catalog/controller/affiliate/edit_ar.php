<?php
class ControllerAffiliateEditAr extends Controller {
	private $error = array();

	public function index() {
		if (!$this->affiliate->isLogged()) {
			$this->session->data['redirect'] = $this->url->link('affiliate/edit_ar', '', 'SSL');
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
      	...
      	$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('affiliate/edit_ar', '', 'SSL'),       	
        	'separator' => $this->language->get('text_separator')
      	);
		...
		$this->data['action'] = $this->url->link('affiliate/edit_ar', '', 'SSL');
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/affiliate/edit_ar.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/affiliate/edit_ar.tpl';
		} else {
			$this->template = 'default/template/affiliate/edit_ar.tpl';
		}
