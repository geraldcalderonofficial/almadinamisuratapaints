<?php
class ControllerAffiliateTransactionAr extends Controller {
	public function index() {
		if (!$this->affiliate->isLogged()) {
			$this->session->data['redirect'] = $this->url->link('affiliate/transaction_ar', '', 'SSL');
		...
		$this->document->setTitle($this->language->get('heading_title'));
      	...
      	$this->data['breadcrumbs'][] = array(       	
			...
			'href'      => $this->url->link('affiliate/transaction_ar', '', 'SSL'),
        	'separator' => $this->language->get('text_separator')
      	);
		...
		$pagination->url = $this->url->link('affiliate/transaction_ar', 'page={page}', 'SSL');
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/affiliate/transaction_ar.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/affiliate/transaction_ar.tpl';
		} else {
			$this->template = 'default/template/affiliate/transaction_ar.tpl';
		}
