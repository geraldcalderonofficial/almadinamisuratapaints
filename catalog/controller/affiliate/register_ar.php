<?php 
class ControllerAffiliateRegisterAr extends Controller {
	private $error = array();
	      
  	public function index() {
		if ($this->affiliate->isLogged()) {
	  		$this->redirect($this->url->link('affiliate/account_ar', '', 'SSL'));
    	}
    	...
    	if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->affiliate->login($this->request->post['email'], $this->request->post['password']);
	  		...
	  		$this->redirect($this->url->link('affiliate/success_ar'));
    	} 
      	...
      	$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('affiliate/register_ar', '', 'SSL'),      	
        	'separator' => $this->language->get('text_separator')
      	);
		...
		$this->data['text_account_already'] = sprintf($this->language->get('text_account_already'), $this->url->link('affiliate/login_ar', '', 'SSL'));
    	...
    	$this->data['action'] = $this->url->link('affiliate/register_ar', '', 'SSL');
		...
		if ($this->config->get('config_affiliate_id')) {
			...
			if ($information_info) {
				$this->data['text_agree'] = sprintf($this->language->get('text_agree'), $this->url->link('information/information_ar/info', 'information_id=' . $this->config->get('config_affiliate_id'), 'SSL'), $information_info['title'], $information_info['title']);
			} else {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/affiliate/register_ar.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/affiliate/register_ar.tpl';
		} else {
			$this->template = 'default/template/affiliate/register_ar.tpl';
		}
