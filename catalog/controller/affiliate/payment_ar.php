<?php
class ControllerAffiliatePaymentAr extends Controller {
	private $error = array();

	public function index() {
		if (!$this->affiliate->isLogged()) {
			$this->session->data['redirect'] = $this->url->link('affiliate/payment_ar', '', 'SSL');
		...
		if ($this->request->server['REQUEST_METHOD'] == 'POST') {
      	...
      	$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('affiliate/payment_ar', '', 'SSL'),       	
        	'separator' => $this->language->get('text_separator')
      	);
		...
		$this->data['action'] = $this->url->link('affiliate/payment_ar', '', 'SSL');
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/affiliate/payment_ar.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/affiliate/payment_ar.tpl';
		} else {
			$this->template = 'default/template/affiliate/payment_ar.tpl';
		}
