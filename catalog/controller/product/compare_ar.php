<?php  
class ControllerProductCompareAr extends Controller {
	public function index() { 
		...
		if (isset($this->request->get['remove'])) {
			...
			$this->redirect($this->url->link('product/compare_ar'));
		}
		...
		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('product/compare_ar'),			
		...
		foreach ($this->session->data['compare'] as $key => $product_id) {
			...
			if ($product_info) {
				...
				$this->data['products'][$product_id] = array(
					...
					'href'         => $this->url->link('product/product_ar', 'product_id=' . $product_id),
					'remove'       => $this->url->link('product/compare_ar', 'remove=' . $product_id)
				);
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/compare_ar.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/product/compare_ar.tpl';
		} else {
			$this->template = 'default/template/product/compare_ar.tpl';
		}
	...
	public function add() {
		...
		if ($product_info) {
			...
			$json['success'] = sprintf($this->language->get('text_success'), $this->url->link('product/product_ar', 'product_id=' . $this->request->post['product_id']), $product_info['name'], $this->url->link('product/compare_ar'));				
