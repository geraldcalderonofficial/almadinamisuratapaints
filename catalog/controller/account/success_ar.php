<?php 
class ControllerAccountSuccessAr extends Controller {  
	public function index() {
		...
		$this->data['breadcrumbs'] = array();
      	...
      	$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('account/success_ar'),
        	'separator' => $this->language->get('text_separator')
      	);
		...
		if ($customer_group && !$customer_group['approval']) {
    		$this->data['text_message'] = sprintf($this->language->get('text_message'), $this->url->link('information/contact_ar'));
		} else {
		...
		if ($this->cart->hasProducts()) {
			$this->data['continue'] = $this->url->link('checkout/cart_ar', '', 'SSL');
		} else {
