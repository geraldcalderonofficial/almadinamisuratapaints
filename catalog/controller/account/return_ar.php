<?php 
class ControllerAccountReturnAr extends Controller { 
	private $error = array();
	
	public function index() {
    	if (!$this->customer->isLogged()) {
      		$this->session->data['redirect'] = $this->url->link('account/return_ar', '', 'SSL');
		...
		if (isset($this->request->get['page'])) {
      	...
      	$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('account/return_ar', $url, 'SSL'),        	
        	'separator' => $this->language->get('text_separator')
      	);
		...
		foreach ($results as $result) {
			$this->data['returns'][] = array(
				...
				'href'       => $this->url->link('account/return_ar/info', 'return_id=' . $result['return_id'] . $url, 'SSL')
			);
		}
		...
		$pagination->url = $this->url->link('account/history_ar', 'page={page}', 'SSL');
		
		$this->data['pagination'] = $pagination->render();

		$this->data['continue'] = $this->url->link('account/account_ar', '', 'SSL');
		
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/return_list_ar.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/account/return_list_ar.tpl';
		} else {
			$this->template = 'default/template/account/return_list_ar.tpl';
		}
	...
	public function info() {
		...
		if (!$this->customer->isLogged()) {
			$this->session->data['redirect'] = $this->url->link('account/return_ar/info', 'return_id=' . $return_id, 'SSL');
		...
		if ($return_info) {
			...
			$this->data['breadcrumbs'][] = array(
				'text'      => $this->language->get('text_home'),
				'href'      => $this->url->link('common/home_ar', '', 'SSL'),
				'separator' => false
			);
			...
			$this->data['breadcrumbs'][] = array(
				...
				'href'      => $this->url->link('account/return_ar/info', 'return_id=' . $this->request->get['return_id'] . $url, 'SSL'),
				'separator' => $this->language->get('text_separator')
			);			
			...
			$this->data['continue'] = $this->url->link('account/return_ar', $url, 'SSL');

			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/return_info_ar.tpl')) {
				$this->template = $this->config->get('config_template') . '/template/account/return_info_ar.tpl';
			} else {
				$this->template = 'default/template/account/return_info_ar.tpl';
			}
			...
			$this->data['breadcrumbs'][] = array(
				'text'      => $this->language->get('heading_title'),
				'href'      => $this->url->link('account/return_ar', '', 'SSL'),
				'separator' => $this->language->get('text_separator')
			);
			...
			$this->data['breadcrumbs'][] = array(
				'text'      => $this->language->get('text_return'),
				'href'      => $this->url->link('account/return_ar/info', 'return_id=' . $return_id . $url, 'SSL'),
				'separator' => $this->language->get('text_separator')
			);
			...
			$this->data['continue'] = $this->url->link('account/return_ar', '', 'SSL');
	...
	public function insert() {
    	...
    	if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->redirect($this->url->link('account/return_ar/success', '', 'SSL'));
    	} 
		...
		$this->document->setTitle($this->language->get('heading_title'));
      	...
      	$this->data['breadcrumbs'][] = array(       	
        	'text'      => $this->language->get('heading_title'),
			'href'      => $this->url->link('account/return_ar/insert', '', 'SSL'),
        	'separator' => $this->language->get('text_separator')
      	);
		...
		$this->data['action'] = $this->url->link('account/return_ar/insert', '', 'SSL');
		...
		if ($this->config->get('config_return_id')) {
			...
			if ($information_info) {
				$this->data['text_agree'] = sprintf($this->language->get('text_agree'), $this->url->link('information/information_ar/info', 'information_id=' . $this->config->get('config_return_id'), 'SSL'), $information_info['title'], $information_info['title']);
			} else {
		...
		$this->data['back'] = $this->url->link('account/account_ar', '', 'SSL');
				
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/return_form_ar.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/account/return_form_ar.tpl';
		} else {
			$this->template = 'default/template/account/return_form_ar.tpl';
		}
