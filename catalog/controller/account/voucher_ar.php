<?php 
class ControllerAccountVoucherAr extends Controller { 
	private $error = array();
	...
	public function index() {
    	...
    	if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			$this->session->data['vouchers'][mt_rand()] = array(
	  		...
	  		$this->redirect($this->url->link('account/voucher_ar/success'));
    	} 		
      	...
      	$this->data['breadcrumbs'][] = array(       	
			...
			'href'      => $this->url->link('account/voucher_ar', '', 'SSL'),
        	'separator' => $this->language->get('text_separator')
      	);
		...
		$this->data['action'] = $this->url->link('account/voucher_ar', '', 'SSL');
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/voucher_ar.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/account/voucher_ar.tpl';
		} else {
			$this->template = 'default/template/account/voucher_ar.tpl';
		}
  	...
  	public function success() {
		...
		$this->document->setTitle($this->language->get('heading_title')); 
      	...
      	$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('account/voucher_ar'),
        	'separator' => $this->language->get('text_separator')
      	);	
    	...
    	$this->data['continue'] = $this->url->link('checkout/cart_ar');
