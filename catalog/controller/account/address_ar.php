<?php 
class ControllerAccountAddressAr extends Controller {
	private $error = array();
	  
  	public function index() {
    	if (!$this->customer->isLogged()) {
	  		$this->session->data['redirect'] = $this->url->link('account/address_ar', '', 'SSL');
  	...
  	public function insert() {
    	...
    	if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_account_address->addAddress($this->request->post);
	  		...
	  		$this->redirect($this->url->link('account/address_ar', '', 'SSL'));
    	} 
  	...
  	protected function getList() {
      	...
      	$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('account/address_ar', '', 'SSL'),
        	'separator' => $this->language->get('text_separator')
      	);
    	...
    	foreach ($results as $result) {
			...
			$replace = array(
      		...
      		$this->data['addresses'][] = array(
        		...
        		'update'     => $this->url->link('account/address_ar/update', 'address_id=' . $result['address_id'], 'SSL'),
				'delete'     => $this->url->link('account/address_ar/delete', 'address_id=' . $result['address_id'], 'SSL')
      		);
    	}

    	$this->data['insert'] = $this->url->link('account/address_ar/insert', '', 'SSL');
		$this->data['back'] = $this->url->link('account/account_ar', '', 'SSL');
				
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/address_list_ar.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/account/address_list_ar.tpl';
		} else {
			$this->template = 'default/template/account/address_list_ar.tpl';
		}
  	...
  	protected function getForm() {
		...
		if (!isset($this->request->get['address_id'])) {
      		$this->data['breadcrumbs'][] = array(
				...
				'href'      => $this->url->link('account/address_ar/insert', '', 'SSL'),       		
        		'separator' => $this->language->get('text_separator')
      		);
		} else {
      		$this->data['breadcrumbs'][] = array(
        		'text'      => $this->language->get('text_edit_address'),
				'href'      => $this->url->link('account/address_ar/update', 'address_id=' . $this->request->get['address_id'], 'SSL'),       		
        		'separator' => $this->language->get('text_separator')
      		);
		}
		...
		if (!isset($this->request->get['address_id'])) {
    		$this->data['action'] = $this->url->link('account/address_ar/insert', '', 'SSL');
		} else {
    		$this->data['action'] = $this->url->link('account/address_ar/update', 'address_id=' . $this->request->get['address_id'], 'SSL');
		}
    	...
    	$this->data['back'] = $this->url->link('account/address_ar', '', 'SSL');
		
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/address_form_ar.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/account/address_form_ar.tpl';
		} else {
			$this->template = 'default/template/account/address_form_ar.tpl';
		}
