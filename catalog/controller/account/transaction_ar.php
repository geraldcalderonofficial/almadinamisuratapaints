<?php
class ControllerAccountTransactionAr extends Controller {
	public function index() {
		if (!$this->customer->isLogged()) {
			$this->session->data['redirect'] = $this->url->link('account/transaction_ar', '', 'SSL');
		...
		$this->document->setTitle($this->language->get('heading_title'));
      	...
      	$this->data['breadcrumbs'][] = array(       	
			...
			'href'      => $this->url->link('account/transaction_ar', '', 'SSL'),
        	'separator' => $this->language->get('text_separator')
      	);
		...
		$pagination->url = $this->url->link('account/transaction_ar', 'page={page}', 'SSL');
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/account/transaction_ar.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/account/transaction_ar.tpl';
		} else {
			$this->template = 'default/template/account/transaction_ar.tpl';
		}
